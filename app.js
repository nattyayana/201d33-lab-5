...
function multiply(a, b) { //eslint-disable-line
  ...
  var multiplyArray = 'The product of ' + a + ' and ' + b + ' is ' + multiplyOfTwoNums + '.';
  console.log(multiplyArray);
  console.log('The product of 5 and 9 is 45.');
  return [multiplyOfTwoNums, multiplyArray];
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  var allThreeSum= sum(firstSum,c)[0];
  console.log(allThreeSum);

  var firstProduct = multiply(a,b)[0];
  var allThreeProduct = multiply(firstProduct,c)[0];
  console.log(allThreeProduct);

  var thirdElement = a + ' and ' + b + ' and ' + c + ' sum to ' + allThreeSum + ' . ';
  console.log(thirdElement);
  var fourthElement = ' The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + allThreeProduct + ' . ';
  console.log(fourthElement);

  return (allThreeSum, allThreeProduct, thirdElement, fourthElement);
...
that takes in an array of numbers as its single argument and then returns an array where the first element is the sum of the numbers in the array,
